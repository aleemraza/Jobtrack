...
<div className="p-6 space-y-6">
    <form action="#" method='POST'>
        <div className="grid grid-cols-10 gap-6">
            ...
            <input class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-cyan-600 focus:border-cyan-600 block w-full p-2.5" aria-describedby="file_input_help" id="file_input" type="file" />
...
<div className="p-6 border-t border-gray-200 rounded-b">
    <button onClick={UserSubmit}   className="text-white bg-cyan-600 hover:bg-cyan-700 focus:ring-4 focus:ring-cyan-200 font-medium rounded-lg text-sm px-5 py-2.5 text-center" type="submit">Update User</button>
</div>
</div>
 </section> 
    </AdminLayouts>
